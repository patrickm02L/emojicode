...
function findMyText(emojis) {
  var haystackText = document.getElementsByClassName("app-main")[0].innerHTML;

  var plurals={}
  emojis.forEach(function(emoji){
    plurals[pluralize(emoji)]=emoji
  });

  //make a list of all plural emoji emojis
  pluralEmojis = emojis.map(function(emoji){
    return pluralize(emoji);
  });
  ...
  var regexp = emojis.join('|');
  regexp = '(' + regexp + ')(?![^<]*>)'
  var match = new RegExp(regexp, "ig");

  var replaced = haystackText.replace(match, function(matchedWord){
    debugger;
